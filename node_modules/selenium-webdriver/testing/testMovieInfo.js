...
driver
    ...
    .then((_) => driver.wait(until.elementTextContains(driver.findElement(By.id('search_phrase')), "pride"), 10000))
    ...
    .then((_) => driver.wait(until.elementTextContains(driver.findElement(By.id('search_phrase')), ""), 10000))
    .then((_) => driver.wait(until.elementTextContains(driver.findElement(By.id('error')), "wrong"), 10000))
    ...
    .then((_) => driver.wait(until.elementTextContains(driver.findElement(By.id('search_phrase')), "Jennifer Aniston"), 10000))
    ...
    .then((_) => driver.wait(until.elementTextContains(driver.findElement(By.id('known')), "Friends"), 10000))
    .then((_) => driver.wait(function(driver) {
        return driver.findElements(By.css("[id='known'] tr")).then(function(rows) {
